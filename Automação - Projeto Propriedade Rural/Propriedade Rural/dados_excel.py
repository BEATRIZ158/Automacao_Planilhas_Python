...
def salvar_em_excel(animal):
    try:
        ...
        if ws.max_row == 1 and ws.max_column == 1 and ws['A1'].value is None:
            ws.append(["Número do Brinco", "Peso", "Data de Entrada", "Número do Piquet", "Preço Ração (Kg)", "Preço Silo (Kg)", "Ração", "Silo", "Nome do Medicamento", "Valor do Medicamento", "Gasto C/Ração 15 dias", "Gasto C/Ração 30 dias"])
